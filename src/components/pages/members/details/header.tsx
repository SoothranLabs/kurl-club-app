...
function Header({ isEditing, handleSave, toggleEdit, memberId }: HeaderProps) {
  ...
  return (
    <div className="flex sticky pt-4 md:pt-[26px] pb-4 z-20 drop-shadow-xl top-[54px] md:top-[80px] w-full items-center bg-primary-blue-500 justify-between gap-3 flex-wrap">
