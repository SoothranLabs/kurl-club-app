...
export function WorkoutPlans() {
  ...
  return (
    <div className="pl-8 overflow-x-auto no-scrollbar">
      <div className="flex gap-3">
        {workoutSchedule.map((day) => (
          <div
            key={day.id}
            className={cn(
              'min-w-[240px] rounded-lg p-4',
              ...
              day.isPresent === true &&
                ...
                : day.isPresent === false
                  ...
                  : 'border border-secondary-blue-300'
            )}
          ...
          >
            ...
            <div className="space-y-2 max-h-[343px] overflow-y-auto no-scrollbar mt-3">
              <DndContext
                id={day.id}
                sensors={sensors}
